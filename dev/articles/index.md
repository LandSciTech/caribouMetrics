...
- [Simulation of monitoring scenarios informed by local
  data](https://landscitech.github.io/caribouMetrics/dev/articles/combine-observed-simulated.md):
- [Comparing the caribouMetrics Beta model to bboutools
  models](https://landscitech.github.io/caribouMetrics/dev/articles/compare-bayesian-models.md):
- [Disturbance
  Metrics](https://landscitech.github.io/caribouMetrics/dev/articles/Using_disturbanceMetric.md):
