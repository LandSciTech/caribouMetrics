...
# Version 2
# most recent seems to be 2014
st_layers("inputNV/FRI/FRI_version2/FRIv2.gdb")
friv2_ind <- st_read("inputNV/FRI/FRI_version2/FRIv2.gdb", 
                     layer = "friv2_fmu_idx")
tl_friv2 <-st_read("inputNV/FRI/FRI_version2/FRIv2.gdb", 
                   layer = "tl")

# Version 1
# most recent seems to be 2000, Lac Seul and Caribou are 1997 and 1996 respectively
tl_friv1 <- st_read("inputNV/FRI/FRI_version1/FRI-FIMv1-NW/TL-120-2000/Troutlake/Data/Troutlake_120.shp")
