...
```{r results1, fig.width=9, fig.height=8, echo=FALSE}
plot(caribouResults, raster.title = "Probability\nof use")
```

### Explanatory variables
Variables used in the model to predict the probability of caribou habitat use. These variables represent the porportion of each habitat type in a 5000 ha moving window, except for the eskers and linear features which represent the density of the feature in the 5000 ha moving window in m/ha. 
```{r results2, fig.width=10, fig.height=10, echo=FALSE}
...
```{r results3, fig.width=10, fig.height=10, echo=FALSE}
