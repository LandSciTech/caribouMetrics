test_that("popGrowthJohnson works", {
  expect_is(popGrowthJohnson(200, 20, 0.5, 0.8, progress = FALSE), "data.frame")
})

test_that("popGrowthJohnson options work", {
  # vector for N
  ...
  # vector for S_bar
  expect_error(popGrowthJohnson(1000, 20, 0.8, 
                                c(rep(0.7, 5), rep(0.8, 5)), progress = FALSE), 
               "must have length")
  
  res3 <- popGrowthJohnson(1:10*100, 20, 0.8, 
                           c(rep(0.7, 5), rep(0.8, 5)), progress = FALSE) 
  ...
  res5 <- popGrowthJohnson(1000, 200, R_bar = 0.7, S_bar = 0.9, P_K = 0.4,
                           progress = FALSE)
