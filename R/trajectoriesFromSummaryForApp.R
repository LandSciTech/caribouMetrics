#' Demographic projections for cases with no change in demographic rates over time.
#' This is the method used (so far) in the demography app.
#' TO DO: Consider removing and replacing with call to trajectoriesFromSummary.
#'
...
#'  outParTab
#'
trajectoriesFromSummaryForApp <- function(numSteps, replicates, N0, R_bar, S_bar, R_sd, S_sd,
