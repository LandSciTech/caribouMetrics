...
#' @family demography
#' @export
bbouNationalPriors<-function(Anthro,fire_excl_anthro,month=T){
  ...
  modBetaEmpty <- bayesianTrajectoryWorkflow(surv_dataE,recruit_dataE,disturbance, returnSamples = TRUE)
