...
#'
#' @inheritParams estimateNationalRates
#'
#' @return For `estimateNationalRate` a similar data frame for one response variable
#'
#' @examples 
...
#'
#'
#' @rdname estimateNationalRates
#' @export

estimateNationalRate <- function(covTable,
                        coefSamples,
                        coefValues,
                        modelVersion,
                        resVar,
