...
runScnSet <- function(scns, ePars, simNational, survAnalysisMethod = "KaplanMeier",
  ...
  # ePars=eParsIn;survAnalysisMethod="Exponential";simsNational=simBig;getKSDists=T;printProgress=F;Niter = formals(caribouBayesianIPM)$Niter;Nburn = formals(caribouBayesianIPM)$Nburn
