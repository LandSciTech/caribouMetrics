...
```{r}
plotRes(mod_tbl, "Recruitment")
```

We can also compare out local observed data to what would be projected by the national model. 
```{r}
...
TO DO: Add something about getPriors and how that can be adjusted?
