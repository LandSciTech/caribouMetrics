...
# simple ggplot
res_tbl <- tabAllRes(mod_real$result, startYear = min(distObs$Year),
                     endYear = max(distObs$Year))
...
caribouMetrics:::plotRes(res_tbl, "Recruitment", labFontSize = 10)
...
caribouMetrics:::plotRes(res_tbl, "Recruitment", simRange = simNational2, labFontSize = 10)
caribouMetrics:::plotRes(res_tbl, "Adult female survival", simRange = simNational2, labFontSize = 10)
caribouMetrics:::plotRes(res_tbl, "Population growth rate", simRange = simNational2, labFontSize = 10)
...
caribouMetrics:::plotRes(mod_tbl$rr.summary.all, "Recruitment", simRange = mod_tbl$sim.all,
                         obs = mod_tbl$obs.all, labFontSize = 10)
