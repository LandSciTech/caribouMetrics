...
carHab2 <- caribouHabitat(
  ...
  friLU = read.csv(paste0(pthBase, "friLU", ".csv"), stringsAsFactors = FALSE) %>%
    mutate(RFU = toupper(RFU) %>% stringr::str_replace("HRDMW", "HRDMX")), 
  caribouRange = "Churchill", padProjPoly = TRUE, winArea = 500
)
```
...
carHab3 <- caribouHabitat(
  ...
  friLU = read.csv(paste0(pthBase, "friLU", ".csv"), stringsAsFactors = FALSE) %>%
    mutate(RFU = toupper(RFU) %>% stringr::str_replace("HRDMW", "HRDMX")), 
  caribouRange = "Churchill", padProjPoly = FALSE, winArea = 500
)
...
# compare results
plot(carHabLF1, season = "Fall", title = "linFeat 1", raster.breaks = 0:20/2/10)
plot(carHabLF2, season = "Fall", title = "linFeat 2", raster.breaks = 0:20/2/10)
