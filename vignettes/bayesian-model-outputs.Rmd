...
outParTabHR <- doSim(
  numSteps = nrow(yrs), numPops = 10000, N0 = NA, R_bar = parTabHighRec$R_bar, 
...
PIParTabHR <- summarizeCaribouPopSim(convertTrajectories(subset(outParTabHR, 
                                                                type == "samp")))
