...
if(useSaved&file.exists(res1File)){
  ...
  mod1 <- bbouMakeSummaryTable(surv_data1,recruit_data1,N0=NA,return_mcmc=T)
...
if(useSaved&file.exists(resFile)){
  ...
  mod <- bbouMakeSummaryTable(surv_data,recruit_data,N0=NA,return_mcmc=T)
...
if(useSaved&file.exists(res2File)){
  ...
  mod2 <- bbouMakeSummaryTable(surv_data2,recruit_data2,N0=NA,return_mcmc=T)
